<template>
  ...
  <div v-if="isLoading" role="status" class="flex justify-center pt-20">
    <svg aria-hidden="true" class="inline w-20 h-20 text-gray-200 animate-spin  fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    >
      ...
      >
        ...
        <tbody class="font-semibold">
          ...
          >
            <td class="px-6 py-4 hover:text-blue-600"> {{responed_data.date}}</td>
            <td class="px-6 py-4 text-center hover:text-blue-600">{{ responed_data.group }}</td>
