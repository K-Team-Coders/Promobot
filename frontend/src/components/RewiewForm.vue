      ...
      >
        ...
        <tbody class="font-semibold">
          ...
          >
            ...
            <td class="px-6 py-4 hover:text-blue-600">2023-11-24</td>
            <td class="px-6 py-4 text-center hover:text-blue-600">group</td>
            ...
            <td class="px-6 py-4 text-center hover:text-blue-600">На улице не убран снег</td>
